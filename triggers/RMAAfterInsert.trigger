...
trigger RMAAfterInsert on RMA__c (after insert) {
    ...
    for(Account acc:accList){
        ...
        /*
        //If it's Cash and is returning material, Unflag the Customer
        else if(acc.DSE_CustomerType__c=='Cash' && acc.DSE_IsCustomer__c==true){
            acc.DSE_IsCustomer__c=false;
            acc.DSE_CustomerType__c=null;
            toUpdateAccList.add(acc);
        }*/
    }
